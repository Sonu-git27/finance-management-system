...
namespace Finance_Project.Migrations
{
    ...
    [Migration("20220321143330_Createdbcontext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.EmiTable", b =>
                {
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.EmiType", b =>
                {
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Logintype", b =>
                {
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Orders", b =>
                {
                    b.Property<decimal>("Orderid")
                        .HasColumnName("orderid")
                        .HasColumnType("numeric(20, 0)");
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Payments", b =>
                {
                    b.Property<decimal>("Paymentid")
                        .HasColumnName("paymentid")
                        .HasColumnType("numeric(18, 0)");
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Products", b =>
                {
                    b.Property<decimal>("ProductId")
                        .HasColumnName("Product_id")
                        .HasColumnType("numeric(18, 0)");
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Registration", b =>
                {
                    b.Property<decimal>("RegId")
                        .HasColumnName("reg_id")
                        .HasColumnType("numeric(18, 0)");
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.UserType", b =>
                {
                    b.Property<decimal>("UsertypeId")
                        .HasColumnName("usertype_id")
                        .HasColumnType("numeric(18, 0)");
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.EmiTable", b =>
                {
                    b.HasOne("Finance_Project.Reposotory.Payments", "Payment")
                        .WithMany("EmiTable")
                        .HasForeignKey("Paymentid")
                        .HasConstraintName("FK__Emi_Table__payme__489AC854");

                    b.HasOne("Finance_Project.Reposotory.Registration", "Reg")
                        .WithMany("EmiTable")
                        .HasForeignKey("RegId")
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.EmiType", b =>
                {
                    b.HasOne("Finance_Project.Reposotory.EmiTable", "Emitype")
                        .WithMany()
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Logintype", b =>
                {
                    b.HasOne("Finance_Project.Reposotory.UserType", "Usertype")
                        .WithMany("Logintype")
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Orders", b =>
                {
                    b.HasOne("Finance_Project.Reposotory.Products", "Product")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Payments", b =>
                {
                    b.HasOne("Finance_Project.Reposotory.Orders", "Order")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Finance_Project.Reposotory.Registration", b =>
                {
                    b.HasOne("Finance_Project.Reposotory.Logintype", "User")
